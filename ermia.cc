...
namespace ermia
{
                           ...
                           const char *primary_name)
  {
    ...
    case kIndexConcurrentMasstree:
      ...
      break;
    case kIndexConcurrentDash:
      index_desc =
          (new ConcurrentDashIndex(name, primary_name))->GetDescriptor();
      break;
    default:
  ...
  void ConcurrentDashIndex::Get(transaction *t, rc_t &rc, const varstr &key,
  ...
  rc_t ConcurrentDashIndex::DoDashPut(transaction &t, const varstr *k,
