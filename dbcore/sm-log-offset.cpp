...
*/
LSN
sm_log_offset_mgr::ptr2lsn(fat_ptr ptr)
{
...
*/
sm_log_offset_mgr::segment_assignment
sm_log_offset_mgr::assign_segment(uint64_t lsn_begin, uint64_t lsn_end)
{
...
sm_log_offset_mgr::_install_segment(segment_id* sid, uint64_t lsn_offset)
{
    ...
    if (nsid and create_segment(nsid))
        return nsid;
